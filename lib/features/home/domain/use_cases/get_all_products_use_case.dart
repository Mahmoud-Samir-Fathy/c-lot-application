...
class GetAllProductsUseCase extends UseCase<Either,String>{
  final GetProductsRepository getProductsRepository;

  GetAllProductsUseCase({required this.getProductsRepository});
  @override
  Future<Either>? call(String params) {

    return getProductsRepository.getAllProducts(params);
  }
